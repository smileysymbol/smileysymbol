...
=======
- Поднимать окружения в Docker (docker-compose up/down, управление контейнерами и окружениями)
...
**Дополнительно**: интересуюсь автоматизацией тестирования (Python/Selenium/Pytest), но в данный момент фокус на углублении навыков ручного тестирования.
